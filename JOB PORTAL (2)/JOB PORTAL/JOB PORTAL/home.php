...
<header class="header">
    <section class="flex">
        ...
        <a href="<?php echo isset($_SESSION['email']) ? 'createpost.php' : 'login.php'; ?>" class="btn" style="margin-top: 0;">Post Job</a>
    </section>
</header>
<!--header-->
...
<div class="home-content">
                ...
                <a href="<?php echo (isset($_SESSION['email']) && $_SESSION['email'] === $row['email']) ? 'profile.php' : 'user.php?email=' . urlencode($row['email']); ?>" class="underline">
                    ...
                    <div class="post-details">
                        ...
                        <div class="editing" id="edit-section-<?php echo $row['post_id']; ?>" style="display: none;">
                            ...
                            <button onclick="savePost(<?php echo $row['post_id']; ?>)">Save</button>
                            <button class="cancel" onclick="cancelEdit(<?php echo $row['post_id']; ?>)">Cancel</button>
                        </div>
    ...
    <?php else: ?>
        <div class="Unavail">
            <h3 style="margin:0% auto;">No Jobs Available</h3>
        </div>
    <?php endif; ?>
</div>
<!--Home-->
